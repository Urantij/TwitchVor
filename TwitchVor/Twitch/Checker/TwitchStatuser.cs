...
internal class TwitchStatuser
{
    ...
    private TwitchCheckInfo? lastCheckInfo = null;
    ...
    private void StreamUp(TwitchCheckInfo check, bool trustworthy)
    {
        lock (locker)
        {
    ...
    private void StreamDown(TwitchCheckInfo check, bool trustworthy)
    {
        lock (locker)
        {
